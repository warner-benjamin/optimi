...
# LICENSE file in the root directory of https://github.com/pytorch/torchdistx.

# AnyPrecisionAdamW: a flexible precision AdamW optimizer with optional Kahan summation
# for high precision weight updates. Allows direct control over momentum, variance and
# auxiliary compensation buffer dtypes. Optional Kahan summation is used to offset
# precision reduction for the weight updates. This allows full training in BFloat16
# (equal or better than FP32 results in many cases) due to high precision weight upates.

# from https://github.com/pytorch/torchdistx/blob/main/src/python/torchdistx/optimizers/anyprecision_optimizer.py

"""Adan optimizer tests using the new Case format (manual list)."""
...
TESTS = [
    ...
    Case(
        ...
        reference_class=reference.Adan,
        reference_params=AdanParams(lr=1e-3, betas=(0.98, 0.92, 0.99), eps=1e-6, weight_decay=2e-2, weight_decouple=True),
    ),
    Case(
